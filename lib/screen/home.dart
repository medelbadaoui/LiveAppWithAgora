...
import 'package:agorartm/screen/agora/recordingmodel.dart';
import 'package:agorartm/screen/recordedlive.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> onCreate({username, image}) async {
    ...
    //start recording
    HomePage.recordingModel = RecordingModel(username, '2020');

    var h = await HomePage.recordingModel.start();
    // push video page with given channel name
    await Navigator.push(
      context,
      MaterialPageRoute(
